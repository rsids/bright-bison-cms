package nl.bs10.bright.commands.custom {
	...
	public class GetCustomTableValueCommand extends BaseCommand implements IAsyncCommand, ICommand {
		
		override public function execute(...args):void {
			super.execute(args);
			
			var call:Object = ServiceController.getService("listService").getListValues(args[0][0]);
			call.table = args[0][0];
