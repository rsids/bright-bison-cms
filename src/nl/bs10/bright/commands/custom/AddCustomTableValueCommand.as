package nl.bs10.bright.commands.custom
{
	...
	public class AddCustomTableValueCommand extends BaseCommand implements IAsyncCommand, ICommand {
		
		override public function execute(...args):void {
			super.execute(args);
			
			var call:Object = ServiceController.getService("listService").addListValue(args[0][0],args[0][1],args[0][2]);
			call.table = args[0][0];
